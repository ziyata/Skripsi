                ...
                viewModel.payCash(
                    ...
                    onSuccess = { headerId, change ->
                        ...
                        val intent = Intent(this, TransaksiDetailActivity::class.java).apply {
                            putExtra(TransaksiDetailActivity.EXTRA_HEADER_ID, headerId)
                            putExtra(TransaksiDetailActivity.EXTRA_TOTAL, totalNow)
                            putExtra(TransaksiDetailActivity.EXTRA_METODE, "CASH")
                            putExtra(TransaksiDetailActivity.EXTRA_TANGGAL, System.currentTimeMillis())
                        }
